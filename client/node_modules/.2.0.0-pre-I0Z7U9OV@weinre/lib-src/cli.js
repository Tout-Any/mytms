...
(function() {
  var _, fs, getDotWeinreServerProperties, getTildeReplacement, nopt, optionDefaults, path, printHelp, printNoptError, replaceTilde, utils, weinre;
  ...
  getDotWeinreServerProperties = function() {
    var contents, fileName, i, key, len, line, lines, match, properties, val;
    properties = {};
