...
(function() {
  var Channel, HttpChannelHandler, _, channelManager, handleCreate, handleError, handleGet, handleOptions, handlePost, setCORSHeaders, setCacheHeaders, utils;
  ...
  module.exports = utils.registerClass(HttpChannelHandler = (function() {
    function HttpChannelHandler(pathPrefix1) {
      this.pathPrefix = pathPrefix1;
  ...
  handleCreate = function(pathPrefix, isClient, request, response) {
    var channel, id, ref, ref1, remoteAddress;
    id = (ref = request.body) != null ? ref.id : void 0;
    remoteAddress = ((ref1 = request.connection) != null ? ref1.remoteAddress : void 0) || "";
  ...
  handleGet = function(request, response, channelName) {
    var channel, ref, remoteAddress;
    remoteAddress = ((ref = request.connection) != null ? ref.remoteAddress : void 0) || "";
...
//# sourceMappingURL=HttpChannelHandler.js.map
